...
class GalleryImagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery_image" do
    assert_difference('GalleryImage.count') do
      post gallery_images_url, params: { gallery_image: { image: @gallery_image.image } }
    end

    assert_redirected_to gallery_image_path(GalleryImage.last)
  end
  ...
  test "should update gallery_image" do
    patch gallery_image_url(@gallery_image), params: { gallery_image: { image: @gallery_image.image } }
    assert_redirected_to gallery_image_path(@gallery_image)
  end
